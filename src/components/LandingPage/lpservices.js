...
<div className="container">
  <div className="button-container">
      <a href="tel:+442045112054" className="whychoose-live"> <button className="letsdiscuss">Let’s Discuss Your Project</button></a>
      <a href="https://wa.me/+447380107663" className="whychoose-live"><button className="live-chat">Live Chat</button></a>
    </div>
    </div>
