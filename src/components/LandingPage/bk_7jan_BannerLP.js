                ...
                <div className="row">
                    ...
                    <div className="col-md-7 lp-left-column">
                        ...
                        <div className="lp-banner-margin">
                            <p className="lpbanner-text">Red Feather Solutions is your ultimate toolkit for visionary web development, packed with advanced features to supercharge your digital journey. </p>
