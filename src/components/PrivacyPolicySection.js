            ...
            <div className="row align-items-center justify-content-center text-center">
                <div className="col-lg-12 py-5 custom-content-v3">
                    ...
                    <p style={{ textAlign: 'justify' }}>
                        ...
                        <p>At Creative Logo Design, we value your privacy and are committed to protecting your personal information. We collect personal information, such as your name and email address, to improve your experience and provide you with updates about our expert and affordable web design services, including but not limited to eCommerce Development, Responsive Websites Design, and Digital Marketing Services.</p>
                        <h4>Data Security</h4>
                        ...
                        <h4>Contact Us</h4>
                        <p>If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:support@webdesignmania.co.uk">support@webdesignmania.co.uk</a>. Thank you for choosing Creative Logo Design!</p>
