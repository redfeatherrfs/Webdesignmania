            ...
            <div className="row align-items-center justify-content-center text-center">
                <div className="col-lg-12 py-5 custom-content-v3">
                    ...
                    <p style={{ textAlign: 'justify' }}>
                        ...
                        <h4>Refund Procedure</h4>
<p>At Red Feather Solutions, refunds will not be granted under the following circumstances:</p>
<ul>
    <li>Opting for an all-inclusive plan.</li>
...
<p><strong>Rights Reserved by Red Feather Solutions</strong></p>
<p>Red Feather Solutions reserves the right to decline any project or terminate an agreement. In the event of a refund, the company retains exclusive ownership of the designs. All designs remain the legal property of Red Feather Solutions.</p>
                        ...
                        <ol>
                            ...
                            <li>Send an email to <a href="mailto:info@redfeathersolutions.com">info@redfeathersolutions.com</a></li>
                        </ol>
                        <p>Upon receiving your refund request, we’ll promptly begin the analysis and processing. Please note that after receiving a refund, you won’t retain ownership rights to designs from Red Feather Solutions. The designs will be submitted to Government Copyright Agencies for legal copyright acquisition.</p>
