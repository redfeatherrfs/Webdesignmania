            ...
            <div className="row align-items-center justify-content-center text-center">
                <div className="col-lg-12 py-5 custom-content-v3">
                    ...
                    <p style={{ textAlign: 'justify' }}>
                        ...
                        <h4>Refund Procedure</h4>
<p>At Creative Logo Design, refunds will not be granted under the following circumstances:</p>
<ul>
    <li>Opting for an all-inclusive plan.</li>
...
<p><strong>Rights Reserved by Creative Logo Design</strong></p>
<p>Creative Logo Design reserves the right to decline any project or terminate an agreement. In the event of a refund, the company retains exclusive ownership of the designs. All designs remain the legal property of Creative Logo Design.</p>

                        <h4>Request Your Refund</h4>
                        <p>To initiate a refund, follow these steps:</p>
                        <ol>
                            <li>Contact us via live chat at our toll-free number <a href="tel:+442045112054">0204-511-2054</a></li>
                            <li>Send an email to <a href="mailto:support@creativelogodesign.co.uk">support@creativelogodesign.co.uk</a></li>
                        </ol>
                        <p>Upon receiving your refund request, we’ll promptly begin the analysis and processing. Please note that after receiving a refund, you won’t retain ownership rights to designs from Creative Logo Design. The designs will be submitted to Government Copyright Agencies for legal copyright acquisition.</p>
