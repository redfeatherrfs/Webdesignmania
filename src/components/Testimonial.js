    ...
    const testimonials = [
        {
            ...
            quote: "We couldn't be more pleased with the app design provided by Creative Logo Design. The interface is intuitive, the design is clean and modern, and the user experience has been dramatically improved. Adil and the team were professional, easy to work with, and consistently delivered on every milestone. Our app now stands out in a competitive market!",
            name: 'R. Simmons',
            image: download,
        },
        {
            heading: "Creative Logo Design did an amazing job...",
            quote: "Creative Logo Design did an amazing job with our logo and stationery design. They created a cohesive and elegant brand package that perfectly aligns with our business vision. The designs were delivered quickly, and they exceeded our expectations in both creativity and quality. We've received so many compliments on our new branding!",
            name: 'Victor Watson',
            image: download,
        },
        {
            heading: "We chose Creative Logo Design for our...",
            quote: "We chose Creative Logo Design for our eCommerce redesign, and it was the best decision we made. Their team was extremely professional, guiding us through every step of the design process. The end result is a stunning website that has improved our user engagement and boosted our online sales. The site is responsive, easy to navigate, and optimized for all devices. Creative Logo Design truly understands how to create a high-converting eCommerce platform!",
            name: 'Charles Parks',
            image: download,
        },
