...
const LogoDesign = () => {
    ...
    return (
        ...
        <Helmet>
            ...
            <meta name="description" content="Get unique branding with custom logo design services by expert designers at Creative Logo Design. Stand out with a logo that truly represents your business." />
        </Helmet>     
         <HeaderSection />
         <BannerSection
